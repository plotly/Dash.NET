...
module RangeSlider =
    ...
    ///</summary>
    type Attr = private WrappedAttr of Dash.NET.DCC.RangeSlider.Attr with
        ...
        ///</summary>
        static member allowCross(p: bool) =
            guardAgainstNull "p" p
            OAttr.allowCross p |> Attr.Wrap
        ///<summary>
    ...
    ///session: window.sessionStorage, data is cleared once the browser quit.
    ///</summary>
    let rangeSlider (id: string, [<ParamArray>] attrs: array<Attr>) = Dash.NET.DCC.RangeSlider.rangeSlider id (attrs |> List.ofArray |> List.map Attr.Unwrap) |> Dash.NET.CSharp.Dsl.DashComponent.Wrap